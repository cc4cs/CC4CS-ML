...
# load dataset
        ...
        with open(os.getcwd()+"\\"+p+"\\RandomForest\\results.csv",'w') as f:
            writer = csv.writer(f)
            ...
            for depth in [2,4,8,16]:
                ...
                print('training time for randomForest_'+p+'_depth'+str(depth)+'_Multi:'+str(testing_t))
        ...
        #single target
            for i in [0,1,2,3,4]:
                ...
                for depth in [2,4,8,16]:
                    ...
                    reg.predict(x_test)
                    testing_t=time.time()-testing_t
                    print('training time for randomForest_'+p+'_depth'+str(depth)+'_'+firstline[37+i]+':'+str(testing_t))
